...
def extract_particles(
    ...
    if relion5_compat:
        ...
        center = dims / 2  # we approximate the center, the correct way would be to use the
        # original dimensions and calculate: center = (ubinned_dims / 2) - 1 (as is done in relion5)
